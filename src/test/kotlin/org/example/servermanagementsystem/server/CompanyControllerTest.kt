...
class CompanyControllerTest : AbstractTest() {
    ...
    fun createCompanyTest() {
        ...
        Assertions.assertEquals(2, doctorRepository.count())
    }
    ...
    fun updateCompanyTest() {
        ...
        val updated = doctorRepository.findById(testCompany.id).get()
    ...
    fun deleteCompanyTest() {
        ...
        val exists = doctorRepository.existsById(testCompany.id)
